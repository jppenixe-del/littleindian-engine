...
// 🦅 napk9.rs — UMA cabeça, SEM chaos. O "Cycle found" vinha de ter 2 saídas (eval+chaos)
//   a partilhar o acumulador → o otimizador do bullet (FusePointwise/SwapOutputs) criava
//   ciclo. Como a fear/chaos é MARGINAL (<5 Elo, decidido), tiramo-la do treino: 1 só saída
//   = sem ciclo possível. A cabeça escolhe-se por env NAPK_HEAD = bullet|small|big.
